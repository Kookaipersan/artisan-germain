...
function AlimentationPage() {
    ...
    fetch("https://artisan-germain-backend.onrender.com/api/artisans")
      ...
      .then((data) => {
        const filtered = data.filter((artisan) =>
          [1, 2, 3, 4].includes(artisan.specialite_id) // à ajuster selon ta BDD
        );
  ...
  return (
    <section className="alimentation-section py-5">
      <div className="text-center mb-4">
        <h2 className="alimentation-title">Artisans de l'alimentation</h2>
