...
function FabricationPage() {
    ...
    fetch("https://artisan-germain-backend.onrender.com/api/artisans")
      ...
      .then((data) => {
        const filtered = data.filter((artisan) =>
          [9, 10, 11].includes(artisan.specialite_id) // à ajuster selon ta BDD
        );
  ...
  return (
    <section className="fabrication-section py-5">
      <div className="text-center mb-4">
        <h2 className="fabrication-title">Artisans de Fabrication</h2>
